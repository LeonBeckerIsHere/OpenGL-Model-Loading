...
GLuint loadTransparentTexture(GLchar* path);
...
int main()
{
	...
	//Additional frambuffer
	GLuint framebuffer;
	glGenFramebuffers(1, &framebuffer);
	glBindFramebuffer(GL_FRAMEBUFFER, framebuffer);

	GLuint texColorBuffer;
	glGenBuffers(1, &texColorBuffer);
...
GLfloat cubeVertices[] = {
	...
	GLfloat planeVertices[] = {
		...
		5.0f, -0.5f,  5.0f,  2.0f,  0.0f,	//top rt
		-5.0f, -0.5f, -5.0f,  0.0f,  2.0f,	//btm lft
		-5.0f, -0.5f,  5.0f,  0.0f,  0.0f,	//top lft


		-5.0f, -0.5f, -5.0f,  0.0f,  2.0f,	//btm lft
		5.0f, -0.5f,  5.0f,  2.0f,  0.0f,	//top rt
		5.0f, -0.5f, -5.0f,  2.0f,  2.0f	//btm rt
	...
	GLuint transparentTexture = loadTransparentTexture("Assets/Textures/blending_transparent_window.png");
#pragma endregion
